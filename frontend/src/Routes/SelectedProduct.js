                    ...
                    <div className="p-5 w-full   shadow-md rounded-md min-h-[500px] flex flex-col justify-around ">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2  ">
                                <div>
                                    <p className="text-gray-500 text-sm mt-3 ">{product.}</p>
                                    <p className="border-b-2 border-b-gray-200 ">
                                        {product.product_detail.spec.memory}
                                    </p>
                                </div>
                                <div>
                                    <p className="text-gray-500 text-sm mt-3 ">Sensor</p>
                                    <p className=" border-b-2 border-b-gray-200 ">
                                        {product.product_detail.spec.sensor}
                                    </p>
                                </div>
