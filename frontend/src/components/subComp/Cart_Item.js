  ...
  return (
    <div className="  border p-2 border-gray-300 mt-4 relative ">
      ...
      <div className="flex flex-row w-full  relative ">
        ...
        <img
          src={product.img[0]}
          className="object-contain sm:w-[150px] h-[150px]  w-[150px]  "
        />
        ...
        <div className="h-[150px]  ml-5 flex flex-col justify-between text-sm  ">
          ...
          <div className="flex flex-start font-bold ">
            <p>Qty:</p>
            <p className="bg-slate-100 flex ml-1  rounded-sm flex-row justify-between  ">
              <span className="text-gray-400 px-2    cursor-pointer hover:bg-slate-300">
                +
              </span>
              <p className="px-1">{product.quan}</p>
              <span className="text-gray-400  cursor-pointer px-2 hover:bg-slate-300">
                -
              </span>
            </p>
          </div>
