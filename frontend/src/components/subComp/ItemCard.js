      ...
      <div key={index}>
        <Link to={"/productdetail/" + item._id}>
          <div className="max-w-[200px] min-h-full  cursor-pointer flex flex-col justify-between hover:scale-105 duration-150 h-full bg-white ">
            <img src={item.img} className="  h-56 w-full mx-auto object-contain"  />
            <div className="p-2 ">
              ...
              <div className="w-full flex items-center ">
                ...
                <span className="text-[9px] font-bold text-orange-500 ml-[0.5px]">{'on Rent'}</span>
              </div>
            </div>
          </div>
        </Link>
