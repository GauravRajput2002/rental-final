      ...
      <div className="max-w-[1600px] mx-auto px-5  shadow-md z-20 h-16 sticky top-0 w-full bg-white  ">
        ...
        <nav className={`flex justify-between items-center h-full`}>
          ...
          <ul className="  hidden md:flex h-full   ">
            <Link
              to={"/"}
              className="px-1   flex flex-col  items-center justify-center  cursor-pointer  hover:border-b-purple-600 border-b-white border-b-2 duration-100 relative h-16  mb-1 mr-2"
            >
              All Products
            </Link>

            <Link to={"/categorywise/" + 'Gadgets'}
              className="px-1   flex flex-col  items-center justify-center  cursor-pointer  hover:border-b-purple-600 border-b-white border-b-2 duration-100 relative h-16  mb-1 mr-2"
            >
              Tech Gadgets
            </Link>

            <Link to={"/categorywise/" + 'Furniture'}
              className="px-1   flex flex-col  items-center justify-center  cursor-pointer  hover:border-b-purple-600 border-b-white border-b-2 duration-100 relative h-16  mb-1 mr-2"
            >
              Furniture
            </Link>
            <Link to={"/categorywise/" + 'Home-Appliances'}
              className="px-1   flex flex-col  items-center justify-center  cursor-pointer  hover:border-b-purple-600 border-b-white border-b-2 duration-100 relative h-16  mb-1 mr-2"
            >
              Home Appliances
            </Link>
